...
class NInputLogOnline(NInputFile):
    def __init__(self, datetime, product, item, tryTimes = 1, interval = 0, idx=-1):
        ...
        super(NInputFile, self).__init__( None)
...
#self.setTaskIOType(None)
    def wGetDownload(self, dateTime, product, item, oFile):
        cmd = "wget"
        site = "http://online.logdata.baidu.com/?m=Data&a=GetData&token=ecom_cpro_2ig4tj1tsbai41tunq5rvi"
